...
export const CANCELLED_ORDER_STATUS = ["CANCELLED", "EXPIRED", "ORDER_CANCEL"];
    ...
    renderFooter: ({
      ...
      const menuList = [
        ...
        printInvoiceBtn({ orderId }),
        {
          label: "Complain Order",
          hidden:
            differenceInDays(new Date(), parseISO(deliveredOrderDate)) < 7,
          onClick: () => {
            openModalComplainOrder();
            handleCloseActionMenu();
          },
...
export const PARAMS_STATUS_DISPUTED_ORDER = {
  ...
  REJECTED: ["REFUND_REJECTED", "RETURN_REJECTED"],
  CLOSED: ["REPLACEMENT_DELIVERY_ACKNOWLEDGED", "CLOSED"],
};
...
export const DISPUTED_CATEGORIES = [
  ...
  { label: "Replacement in Progress", param: "REPLACEMENT_IN_PROGRESS" },
